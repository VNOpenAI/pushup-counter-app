...
from resnest.torch import (resnest50, resnest50_fast_4s2x40d, resnest101,
                           resnest200, resnest269)

from models.efficientnet_head import Efficient_head
...
class KeypointHeatmapENB2Model():
